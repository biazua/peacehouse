                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.mms.campaign_builder') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="select2 form-select" name="contact_groups[]"
                                                    id="contact_groups" multiple="multiple">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label for="message"
                                                   class="form-label">{{__('locale.labels.message')}}</label>
