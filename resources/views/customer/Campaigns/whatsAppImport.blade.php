                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.whatsapp.import') }}"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <a href="{{route('sample.file')}}"
                                               class="btn btn-primary px-1 py-1 waves-effect waves-light btn-md fw-bold">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="select2 form-select" name="sending_server"
                                                    ...
                                                    @foreach($sendingServers as $server)
                                                        @if(isset($server->sendingServer) && $server->sendingServer->status == 1 && $server->sendingServer->whatsapp)
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" checked value="true" class="form-check-input"
                                                       name="header">
                                                <label class="form-check-label">{{ __('locale.filezone.file_contains_header_row') }}
                                                    ?</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label">{{__('locale.campaigns.schedule_campaign')}}
                                                    ?</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <button type="submit" class="btn btn-primary mt-1 mb-1"><i
                                                    data-feather="send"></i> {{ __('locale.buttons.import') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
