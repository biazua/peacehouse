                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.whatsapp.quick_send') }}"
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <small class="text-primary text-uppercase text-start"
                                                       id="remaining">1000 {{ __('locale.labels.characters_remaining') }}</small>
      ...
      $(document).ready(function() {
        ...
        function get_character() {
          if ($get_msg[0].value !== null) {
            ...
            let data = SmsCounter.count($get_msg[0].value, "WHATSAPP");
