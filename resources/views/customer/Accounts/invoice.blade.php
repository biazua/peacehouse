                    ...
                    <div class="card-body invoice-padding pt-0">
                        <div class="row invoice-spacing">
                            <div class="col-xl-8 p-0">
                                ...
                                <p class="card-text mb-25">{{ $invoice->user->customer->state }}
                                    -{{ $invoice->user->customer->postcode }}</p>
                            ...
                            <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ Tool::format_price($invoice->amount, $invoice->currency->format) }}</span>
                                        </td>
                                    </tr>
                            ...
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount">{{ Tool::format_price($invoice->amount - $invoice->tax, $invoice->currency->format) }}</p>
                                    </div>
                                    <div class="invoice-total-item">
                                        <p class="invoice-total-title">{{ __('locale.labels.tax') }}
                                            ({{Tool::calculateTaxPercentage($invoice->amount, $invoice->tax)}}%):</p>
                                        <p class="invoice-total-amount">{{ Tool::format_price($invoice->tax, $invoice->currency->format) }}</p>
                                    </div>
                                    <hr class="my-50"/>
                                    <div class="invoice-total-item">
                                        <p class="invoice-total-title">{{ __('locale.labels.total') }}:</p>
                                        <p class="invoice-total-amount">{{ Tool::format_price($invoice->amount, $invoice->currency->format) }}</p>
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-primary w-100 mb-75"
                           href="{{ route('customer.invoices.print', $invoice->uid) }}" target="_blank"> <i
                                    data-feather="printer"></i> {{ __('locale.labels.print') }}</a>
                    </div>
                </div>
            </div>
            <!-- /Invoice Actions -->
