                            ...
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount">{{ \App\Library\Tool::format_price($invoice->amount - $invoice->tax, $invoice->currency->format) }}</p>
                                    </div>

                                    <div class="invoice-total-item">
                                        <p class="invoice-total-title">{{ __('locale.labels.tax') }} ({{\App\Library\Tool::calculateTaxPercentage($invoice->amount, $invoice->tax)}}%):</p>
                                        <p class="invoice-total-amount">{{ \App\Library\Tool::format_price($invoice->tax, $invoice->currency->format) }}</p>
                                    </div>
                                    <hr class="my-50"/>
                                    <div class="invoice-total-item">
