                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" name="status" id="status">
                                                    ...
                                                    <option value="block" {{ isset($senderid->status) && $senderid->status == 'block' ? 'selected' : null }}>{{ __('locale.buttons.block')}} </option>
                                                </select>
                                                @error('status')
                                                <p><small class="text-danger">{{ $message }}</small></p>
                                                @enderror
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" id="billing_cycle" name="billing_cycle">
                                                    @foreach (\App\Enums\BillingCycleEnum::getAllValues() as $cycle)
                                                        <option value="{{ $cycle }}" {{ $senderid->billing_cycle == $cycle ? 'selected': null }}> {{__('locale.labels.'.$cycle)}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('billing_cycle')
