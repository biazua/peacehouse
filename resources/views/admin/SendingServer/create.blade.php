                            ...
                            <div class="card-body">
                                ...
                                @switch($server['settings'])
                                    ...
                                    @case(SendingServer::TYPE_DIAFAAN)
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.diafaan') }}</code></p>
                                        @break
                                    ...
                                    @case(SendingServer::TYPE_D7NETWORKS)
                                        <p> To Receive Inbound Message please login with your D7Networks portal and
                                            ...
                                            this url:
                                            <code> {{ route('inbound.d7networks') }}</code> on your <code>Inbound
                                                Settings -> Webhook</code> field. For Delivery reports please insert
                                            this url: <code> {{ route('dlr.d7networks') }}</code> on your <code>Settings
                                    ...
                                    @case(SendingServer::TYPE_800COM)
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.800com') }}</code></p>
                                        @break

                                    @case(SendingServer::TYPE_EASYSMSXYZ)
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.smsgateway') }}</code></p>
                                        @break

                                    @case('BurstSMS')
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.burstsms') }}</code></p>
                                        @break

                                    @case(SendingServer::TYPE_SINCH)
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.sinch') }}</code></p>
                                        @break
                                    ...
                                    @case('Ejoin')
                                        <p>For Inbound Message Here is the Callback URL:
                                            <code>{{ route('inbound.ejoin') }}</code></p>
                                        @break
                                    ...
                                    @case(SendingServer::TYPE_TXTRIA)
                                        <p>Create a new TxTRIA account <a href="https://txtria.com/console/contact"
                                            ...
                                            <code>{{route('inbound.txtria')}}</code>. Finally, click the <code>Save
                                                Now</code> button.</p>
                                        @break
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if( $server['settings'] != 'Twilio' && $server['settings'] != 'Zang' && $server['settings'] != 'Plivo' && $server['settings'] != 'PlivoPowerpack' && $server['settings'] != 'AmazonSNS' && $server['settings'] != 'TwilioCopilot' && $server['settings'] != SendingServer::TYPE_ULTRAMSG && $server['settings'] != SendingServer::TYPE_CLICKSEND && $server['settings'] != SendingServer::TYPE_VERIFYSMSURWAY)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_TELNYX || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == SendingServer::TYPE_AIRTELINDIA || $server['settings'] == SendingServer::TYPE_ALDEAMO || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMSURWAY || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS || $server['settings'] == SendingServer::TYPE_TURKEYSMS|| $server['settings'] == SendingServer::TYPE_VERIFYSMSURWAY)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == 'GatewaySa' || $server['settings'] == 'SendPulse' || $server['settings'] == SendingServer::TYPE_DIGINTRA || $server['settings'] == SendingServer::TYPE_TONKRA || $server['settings'] == SendingServer::TYPE_MTN || $server['settings'] == SendingServer::TYPE_LINKMOBILITY || $server['settings'] == SendingServer::TYPE_DOTGO)
                                        ...
                                        @if($server['settings'] == 'SendPulse' || $server['settings'] == SendingServer::TYPE_MTN || $server['settings'] == SendingServer::TYPE_LINKMOBILITY || $server['settings'] == SendingServer::TYPE_DOTGO)
                                        ...
                                        @if($server['settings'] == 'LuxSMS' || $server['settings'] == SendingServer::TYPE_SMSALA || $server['settings'] == SendingServer::TYPE_SPEEDAMOBILE)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_SMSURWAY || $server['settings'] == SendingServer::TYPE_VERIFYSMSURWAY)
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Plivo' || $server['settings'] == 'Vonage' || $server['settings'] == 'Infobip' || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == 'Telnyx' || $server['settings'] == SendingServer::TYPE_AIRTELINDIA || $server['settings'] == SendingServer::TYPE_AUDIENCEONE || $server['settings'] == SendingServer::TYPE_ALDEAMO || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS || $server['settings'] == SendingServer::TYPE_FORDEMO)
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Clickatell_Touch' || $server['settings'] == SendingServer::TYPE_MESSAGEBIRD || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'WaApi' || $server['settings'] == 'YooAPI' || $server['settings'] == 'Whatsender' || $server['settings'] == 'Xmsway' || $server['settings'] == 'MidasAppBr' || $server['type'] == 'whatsapp' || $server['settings'] == SendingServer::TYPE_BMSGLOBAL || $server['settings'] ==  SendingServer::TYPE_TERMII || $server['settings'] ==  SendingServer::TYPE_WA2SALES || $server['settings'] ==  SendingServer::TYPE_INTERAKT || $server['settings'] == SendingServer::TYPE_FORDEMO || $server['settings'] == SendingServer::TYPE_WHATAPICLOUD || $server['settings'] == SendingServer::TYPE_EBULKSMS)
                                            ...
                                            @if($server['settings'] == SendingServer::TYPE_MESSAGGIO || $server['type'] == 'viber' || $server['settings'] == SendingServer::TYPE_FORDEMO)
                                                <div class="d-flex flex-column">
